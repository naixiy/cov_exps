...
jsPsych.plugins["image-keyboard-response-mda"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('image-keyboard-response-mda', 'stimulus', 'image');

  plugin.info = {
    name: 'image-keyboard-response-mda',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.render_on_canvas) {
      ...
      if (trial.prompt !== null) {
        display_element.insertAdjacentHTML('beforeend', '<p>This is how much energy you have today.<br><br><br>You have also had '+ String(trial.trial_numbers) +' coughing fits today.<br><br><br></p>');
