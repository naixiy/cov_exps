...
jsPsych.plugins["resize-mda"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if(trial.item_width >= trial.item_height){
      ...
      var start_div_height = 50;//Math.round(trial.starting_size / aspect_ratio);
    } else {
      var start_div_height = 50;//trial.starting_size;
      var start_div_width = Math.round(trial.starting_size * aspect_ratio);
    }

    console.log(trial.stim_1);
