...
jsPsych.plugins['free-sort-mda-logo'] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('free-sort-mda', 'stimuli', 'image');
  ...
  plugin.trial = function(display_element, trial) {
    ...
    let html =
      '<img src='+ trial.logo +' align = "left">' +
      '<div '+
      'id="jspsych-free-sort-arena" '+
      'class="jspsych-free-sort-arena" '+
      'style="position: relative; width:'+trial.sort_area_width+'px; height:'+trial.sort_area_height+'px; margin: auto; margin-left: ' + trial.logo_width + 'px;"</div>';
    ...
    const html_text = '<div style="line-height: 1.0em; margin-left: ' + trial.logo_width + 'px;">' + trial.prompt +
